...
public class HTTPUtil {
    ...
    public static String connection(String pUrl, String pPayload, String pMethodType, Map<String, String> pHeaders) throws IOException, KeyManagementException, NoSuchAlgorithmException {
