...
public class GenericExceptionHandler {
    ...
    @ExceptionHandler(value = TwitterAPIServiceUnavailableException.class)
    public RestResponse<String> handleTeamNotFoundException(TwitterAPIServiceUnavailableException ex) {
